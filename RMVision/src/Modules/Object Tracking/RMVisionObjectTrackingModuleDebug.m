...
{
    NMSSHSession *session = [NMSSHSession connectToHost:@"macau.romotive.com:22"
                                           withUsername:@"romo"];
    
    if (session.isConnected) {
        
        [session authenticateByPassword:@"RomoDev0"];
        
        // Example of how to connect with keyboard interactive authentication
